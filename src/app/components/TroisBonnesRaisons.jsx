        ...
        <div className='h-auto w-5/6 m-auto'>
            ...
            <div className='flex flex-col lg:flex-row justify-evenly'>
                <div className='flex h-auto w-auto py-5'>
                    ...
                    <div><p>Nous somme crétatifs et pointus dans notre travail. <br /> Vous pouvez naviguer sur notre site et découvrir <br /> nos références afin de vous en assurer.</p></div>
                </div>
                <div className='flex h-auto w-auto py-5'>
                    <div className='mx-4'>
                    <Image src={deux} width={90} />
                    </div>
                    <div><p>Notre agence est composee d'une petite equipe dirigee <br /> par le graphiste en personne. Vous aurez donc un contact <br /> direct avec celui-ci sans passer par des commerciaux</p></div>
                </div>
                <div className='flex h-auto w-auto py-5'>
                    <div className='mx-4'>
                    <Image src={trois} width={90} />
                    </div>
                    <div><p>Nous exercçons notre metier avec passion et implication. <br /> Le taux de satisfaction de nos clients témoigne <br /> de la qualite de notre travial.</p></div>
                </div>
            </div>
        </div>
    </div>
